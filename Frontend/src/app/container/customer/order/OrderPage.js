        ...
        <div className="card-header d-flex justify-content-between">
          ...
          {this.state.modifiedorderarray.length}
            ...
            <span className="m-0" style={{ fontWeight: "300" }}>
              {" "}
              {this.state.modifiedorderarray[k][0].Order.createdAt.split("T")[0]}
            </span>
          </div>
          <div>
            {" "}
    ...
    {this.state.modifiedorderarray[k].map(i=>(
        ...
        <div key={i._id} className="card-body">
          ...
          <div className='d-flex'>
            ...
            <div>
            <button className='a-button-order p-2' style={{width:"100%"}} onClick={
              e=>{
                this.setState({
        ...
        >
          ...
          >
            ...
            <div className="profile-at-product-image-container upload-photo">
              <img
                alt=""
                src={this.state.cancelOrderProduct.products.photos[0]}
                className="profile-at-product-image"
              />
            </div>
            ...
            <div className="">
              <span className="">
                {this.state.cancelOrderProduct.products.productName}
              </span>
              <div className=''>
                <span
                  style={{
                ...
                >
                  ...
                  >
                    {" "}
                    {this.state.cancelOrderProduct.products.sellerName}
                  </span>
                </span>
              </div>
              <div>
                ...
                >
                  ...
                  >
                    {" "}
                    {this.state.cancelOrderProduct.createdAt.split("T")[0]}
                  </span>
                </span>
              </div>
              </div>
            ...
            <div>
            <label>
            <input type="radio" value="option1" checked={this.state.value} onClick={e=>(this.setState({value:'true'}))} />
            ...
            :''}
                ...
                <div className='form-group col-md-8 m-3'>
                  <input disabled={!this.state.value} type='submit' value='Cancel Order' className='btn btn sprite' />
                </div>
              </form>
            </div>
          </div>
